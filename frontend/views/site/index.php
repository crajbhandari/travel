...
<!--HEADER SECTION-->
<section>
   <?php foreach ($banners as $banner): if($banner['alt_text'] == 'check'):
   ?>
   <div class = "tourz-search" style="background: url('<?= Yii::$app->request->baseUrl.'/common/assets/images/banners/'.$banner['image']; ?>')">
       <?php
   endif;
       endforeach;?>
      <div class = "container">
