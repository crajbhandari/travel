            ...
            <div class = "tourz-search-1">
               ...
               <div class = "tourz-hom-ser">
                  <ul>
                     ...
                     <li>
                        <a href = "booking-hotel.html" class = "waves-effect waves-light btn-large tourz-pop-ser-btn wow fadeInUp" data-wow-duration = "2s"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/1.png" alt = ""> Hotel</a>
                     </li>
                  </ul>
               </div>
            </div>
      ...
      <div class = "container">
         ...
         <div>
            ...
            <div class = "col-md-4 col-sm-6 col-xs-12 b_packages wow slideInUp" data-wow-duration = "0.5s">
               <!-- OFFER BRAND -->
               <div class = "band"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/band.png" alt = ""/></div>
               <!-- IMAGE -->
               <div class = "v_place_img"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/t5.png" alt = "Tour Booking" title = "Tour Booking"/></div>
               <!-- TOUR TITLE & ICONS -->
               <div class = "b_pack rows">
                  ...
                  <div class = "col-md-4 col-sm-4 pack_icon">
                     <ul>
                        <li>
                           <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/clock.png" alt = "Date" title = "Tour Timing"/> </a>
                        </li>
                        <li>
                           <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/info.png" alt = "Details" title = "View more details"/> </a>
                        </li>
                        <li>
                           <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/price.png" alt = "Price" title = "Price"/> </a>
                        </li>
                        <li>
                           <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/map.png" alt = "Location" title = "Location"/> </a>
                        </li>
                     </ul>
                  </div>
               </div>
            ...
            <div class = "col-md-4 col-sm-6 col-xs-12 b_packages wow fadeInUp" data-wow-duration = "1.1s">
               <div class = "v_place_img"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/t3.png" alt = "Tour Booking" title = "Tour Booking"/></div>
               <div class = "b_pack rows">
                  <div class = "col-md-8 col-sm-8">
         ...
         <div class = "col-md-6">
            <a href = "tour-details.html">
               <div class = "tour-mig-like-com">
                  <div class = "tour-mig-lc-img"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/listing/home.jpg" alt = ""></div>
            ...
            <div class = "col-md-4">
               <div class = "to-ho-hotel-con">
                  <div class = "to-ho-hotel-con-1">
                     <div class = "hot-page2-hli-3"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/hci1.png" alt = ""></div>
                     <div class = "hom-hot-av-tic"> Available Tickets: 42</div>
                     <img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/hotels/1.jpg" alt = ""></div>
            ...
            <div class = "col-md-4">
               <div class = "to-ho-hotel-con">
                  <div class = "to-ho-hotel-con-1">
                     ...
                     <img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/hotels/2.jpg" alt = ""></div>
                  <div class = "to-ho-hotel-con-23">
                     <div class = "to-ho-hotel-con-2">
                        <a href = "hotel-details.html">
            ...
            <div class = "col-md-4">
               <div class = "to-ho-hotel-con">
                  <div class = "to-ho-hotel-con-1">
                     ...
                     <img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/hotels/3.jpg" alt = ""></div>
                  <div class = "to-ho-hotel-con-23">
                     <div class = "to-ho-hotel-con-2">
                        <a href = "hotel-details.html">
...
<section>
   <div class = "offer">
      <div class = "container">
         <div class = "row">
            <div class = "col-md-6">
               <div class = "offer-l"><span class = "ol-1"></span> <span class = "ol-2"><i class = "fa fa-star"></i><i class = "fa fa-star"></i><i class = "fa fa-star"></i><i class = "fa fa-star"></i><i class = "fa fa-star"></i></span> <span class = "ol-4">Standardized Budget Rooms</span> <span class = "ol-3"></span>
                  <span class = "ol-5">$99/-</span>
                  <ul>
                     <li class = "wow fadeInUp" data-wow-duration = "0.5s">
                        <a href = "#!" class = "waves-effect waves-light btn-large offer-btn"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/dis1.png" alt = "">
                        </a><span>Free WiFi</span>
                     </li>
                     <li class = "wow fadeInUp" data-wow-duration = "0.7s">
                        <a href = "#!" class = "waves-effect waves-light btn-large offer-btn"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/dis2.png" alt = ""> </a><span>Breakfast</span>
                     </li>
                     <li class = "wow fadeInUp" data-wow-duration = "0.9s">
                        <a href = "#!" class = "waves-effect waves-light btn-large offer-btn"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/dis3.png" alt = ""> </a><span>Pool</span>
                     </li>
                     <li class = "wow fadeInUp" data-wow-duration = "1.1s">
                        <a href = "#!" class = "waves-effect waves-light btn-large offer-btn"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/dis4.png" alt = ""> </a><span>Television</span>
                     </li>
                     <li class = "wow fadeInUp" data-wow-duration = "1.3s">
                        <a href = "#!" class = "waves-effect waves-light btn-large offer-btn"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/icon/dis5.png" alt = ""> </a><span>GYM</span>
                     </li>
                  </ul>
               </div>
            </div>
   ...
   <div class = "rows tb-space">
      <div class = "container events events-1" id = "inner-page-title">
         ...
         <table id = "myTable">
            ...
            <tr>
               <td>1</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-1.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">Taj Mahal,Agra, India</a></td>
            ...
            <tr>
               <td>2</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-2.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">Salesforce Summer, Dubai</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>3</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-3.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">God Towers, TOKYO, JAPAN</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>4</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-4.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">TOUR DE ROMANDIE, Switzerland</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>5</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-5.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">TOUR DE POLOGNE, Poland</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>6</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-6.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">Future of Marketing,Sydney, Australia</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
               <td class = "e_h1">Australia</td>
               <td><a href = "booking.html" class = "link-btn">Book Now</a></td>
            ...
            <tr>
               <td>7</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-7.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">Eiffel Tower, Paris</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>8</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-8.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">PARIS - ROUBAIX, England</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
            ...
            <tr>
               <td>9</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-9.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">Dubai Beach Resort, Dubai</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
               <td class = "e_h1">Dubai</td>
               <td><a href = "booking.html" class = "link-btn">Book Now</a></td>
            ...
            <tr>
               <td>10</td>
               <td><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/iplace-4.jpg" alt = ""/><a href = "hotels-list.html" class = "events-title">TOUR DE POLOGNE, Poland</a></td>
               <td class = "e_h1">16.12.2016</td>
               <td class = "e_h1">10.00 PM</td>
               <td class = "e_h1">Poland</td>
               <td><a href = "booking.html" class = "link-btn">Book Now</a></td>
            ...
            <div class = "col-md-4">
               ...
               <div class = "hot-page2-hom-pre">
                  <ul>
                     ...
                     <li>
                        <a href = "hotels-list.html">
                           <div class = "hot-page2-hom-pre-1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/trends/3.jpg" alt = ""></div>
                           <div class = "hot-page2-hom-pre-2">
...
<section>
   <div class = "foot-mob-sec tb-space">
      <div class = "rows container">
         ...
         <div class = "col-md-6 col-sm-6 col-xs-12 family"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/mobile.png" alt = ""/></div>
         <!-- REQUEST A QUOTE -->
         <div class = "col-md-6 col-sm-6 col-xs-12">
            ...
            <div class = "foot-mob-app">
               ...
               <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/android.png" alt = ""> </a>
               <a href = "#"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/apple.png" alt = ""> </a>
            </div>
         </div>
      </div>
   </div>
