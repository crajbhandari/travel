      ...
      <div class = "container  tb-space">
            ...
            <div class = "tour_head1 hotel-book-room">
               ...
               <div id = "myCarousel1" class = "carousel slide" data-ride = "carousel">
                  ...
                  <ol class = "carousel-indicators carousel-indicators-1">
                     <li data-target = "#myCarousel1" data-slide-to = "0"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t1.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t2.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "2"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t3.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "3"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t4.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "4"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t5.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "5"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/s6.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "6"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/s7.jpg" alt = "Chania"/>
                     </li>
                     <li data-target = "#myCarousel1" data-slide-to = "7"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/s8.jpg" alt = "Chania"/>
                     </li>
                     ...
                     <li data-target = "#myCarousel1" data-slide-to = "9">
                  ...
                  <div class = "carousel-inner carousel-inner1" role = "listbox">
                     <div class = "item active"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t1.jpg" alt = "Chania" width = "460" height = "345"/></div>
                     <div class = "item"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t2.jpg" alt = "Chania" width = "460" height = "345"/></div>
                     <div class = "item"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t3.jpg" alt = "Chania" width = "460" height = "345"/></div>
                     <div class = "item"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t4.jpg" alt = "Chania" width = "460" height = "345"/></div>
                     <div class = "item"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t5.jpg" alt = "Chania" width = "460" height = "345"/></div>
                     <div class = "item"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/gallery/t6.jpg" alt = "Chania" width = "460" height = "345"/></div>
         ...
         <div class = "col-md-3 tour_r">
            ...
            <div class = "tour_right tour_offer">
               <div class = "band1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/offer.png" alt = ""/></div>
               <p>Special Offer</p>
            ...
            <div class = "tour_right tour_rela tour-ri-com">
               ...
               <div class = "tour_rela_1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/related1.png" alt = ""/>
                  <h4>Dubai 7Days / 6Nights</h4>
                  <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text</p>
                  <a href = "#" class = "link-btn">View this Package</a></div>
               <div class = "tour_rela_1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/related2.png" alt = ""/>
                  <h4>Mauritius 4Days / 3Nights</h4>
                  <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text</p>
                  <a href = "#" class = "link-btn">View this Package</a></div>
               <div class = "tour_rela_1"><img src = "<?php echo Yii::$app->request->baseUrl; ?>/resources/images/related3.png" alt = ""/>
