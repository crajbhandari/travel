...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2020 at 09:21 AM
...
--
ALTER TABLE `faq_translation`
  ADD CONSTRAINT `faq_translation_ibfk_1` FOREIGN KEY (`faq_id`) REFERENCES `faq` (`id`),
  ADD CONSTRAINT `faq_translation_ibfk_2` FOREIGN KEY (`language_code`) REFERENCES `language` (`code`);
