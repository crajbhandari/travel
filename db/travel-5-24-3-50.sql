...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2020 at 12:04 PM
...
INSERT INTO `blog` (`id`, `date`, `image`, `category`, `visibility`) VALUES
(4, '2020-04-03 17:41:51', '15882419734.png', 'Travel', 1),
(5, '2020-04-03 19:05:14', '15882419735.png', 'Food', 0),
(6, '2020-04-07 14:30:09', '15882419736.png', 'Hotel', 1),
(7, '2020-04-07 18:58:55', '15882419734.png', 'Trekking', 0),
(9, '2020-04-07 22:06:43', '15882419735.png', 'Travel', 1),
(10, '2020-04-08 10:43:10', '15882419736.png', 'Food', 1),
(13, '2020-05-09 12:44:33', '15882419734.png', 'Hotel', 1),
(14, '2020-05-24 13:03:18', '15903046986.jpg', '', 0);
...
('j96b8nn041lamflnutd5u0h43c', 1590054651, 0x5f5f666c6173687c613a303a7b7d5f5f72657475726e55726c7c733a33323a222f74726176656c2f6170706c65742f7061636b6167652f63617465676f72792f223b5f5f69647c693a313b),
('lqqvcumh0pfbmsrhv62983dvkk', 1590060005, 0x5f5f666c6173687c613a303a7b7d),
('8hm6tfq7sf72m9krjea4k9tmsp', 1590136680, 0x5f5f666c6173687c613a303a7b7d),
('aq3k6v3oodrohhhig9e118ct9o', 1590136639, 0x5f5f666c6173687c613a303a7b7d5f5f72657475726e55726c7c733a31343a222f74726176656c2f6170706c6574223b5f5f69647c693a313b),
('rc4gib3g1tcek0224thukfbjut', 1590205538, 0x5f5f666c6173687c613a303a7b7d),
('8p0vnfi2k383ebk2vh0hd434cn', 1590203498, 0x5f5f666c6173687c613a303a7b7d5f5f72657475726e55726c7c733a31343a222f74726176656c2f6170706c6574223b5f5f69647c693a313b),
('miq6ac5nc222hk8kn3a7os0nh0', 1590301206, 0x5f5f666c6173687c613a303a7b7d5f5f72657475726e55726c7c733a31343a222f74726176656c2f6170706c6574223b5f5f69647c693a313b),
('svui93idrbvvgp3biraihdb472', 1590301204, 0x5f5f666c6173687c613a303a7b7d),
('16cmvt5ug3kebc5hp6eh4qki1d', 1590306070, 0x5f5f666c6173687c613a303a7b7d),
('th792hf4gkr36ut00p1o3afajb', 1590308331, 0x5f5f666c6173687c613a303a7b7d5f5f72657475726e55726c7c733a31343a222f74726176656c2f6170706c6574223b5f5f69647c693a313b);
...
--
ALTER TABLE `city_translation`
  ADD CONSTRAINT `city_translation_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`),
  ADD CONSTRAINT `city_translation_ibfk_2` FOREIGN KEY (`language_code`) REFERENCES `language` (`code`);
...
--
-- Constraints for table `package_category_translation`
--
ALTER TABLE `package_category_translation`
  ADD CONSTRAINT `package_category_translation_ibfk_1` FOREIGN KEY (`package_category_id`) REFERENCES `package_category` (`id`),
  ADD CONSTRAINT `package_category_translation_ibfk_2` FOREIGN KEY (`lamguage_code`) REFERENCES `language` (`code`);

--
-- Constraints for table `package_translation`
--
ALTER TABLE `package_translation`
  ADD CONSTRAINT `package_translation_ibfk_1` FOREIGN KEY (`package_id`) REFERENCES `package` (`id`),
  ADD CONSTRAINT `package_translation_ibfk_2` FOREIGN KEY (`language_code`) REFERENCES `language` (`code`);
