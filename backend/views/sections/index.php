                                    ...
                                    <div class = "p-15">
                                       ...
                                       <div class = "form-group">
                                          ...
                                          <select id = "<?= $row ?>-phone" name = "setting[content][<?= $row ?>][on_footer]" class = "form-control c-footer required">
                                             <option value = "1" <?= (isset($c->on_footer) && $c->on_footer == 1) ? 'selected="selected"' : '' ?>>Show</option>
                                             <option value = "0" <?= (isset($c->on_footer) && $c->on_footer == 0) ? 'selected="selected"' : '' ?>>Hide</option>
                                          </select>
                                       </div>
                                       <div class = "form-group">
                                           <?php $counter++; ?>
